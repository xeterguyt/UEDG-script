...
attackButton.Position = UDim2.new(0.5, -15, 0.5, -15)
attackButton.Size = UDim2.new(0, 30, 0, 30)
attackButton.Text = "A"
...
-- Function untuk menangani klik tombol Attack
...
-- Function untuk menjalankan perintah Smash Attack secara berulang dengan cooldown pada mode otomatis
while true do
    if isAutoMode then
        executeSmashAttack()
